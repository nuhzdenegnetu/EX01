...
- **Passport.js** — библиотека для аутентификации пользователей с поддержкой различных стратегий
...
- **RESTful API**
    - Реализация RESTful-структуры для управления ресурсами
    - Четкое разделение маршрутов по функциональности
    - Использование HTTP-методов (GET, POST, PUT, DELETE) для операций с ресурсами
- **Шаблонизация**
    - Использование Pug для рендеринга страниц пользователей и главной страницы
    - Использование EJS для рендеринга страниц статей
    - Динамическое создание HTML-страниц с данными из базы
- **Middleware**
    - Логирование запросов и ответов
    - Обработка ошибок и централизованная обработка исключений
    - Проверка авторизации и аутентификации пользователей
- **Docker**
    - Контейнеризация приложения для упрощения развертывания
    - Использование Dockerfile для создания образа приложения
    - Поддержка многоконтейнерной архитектуры с использованием Docker Compose
...
- **CRUD операции**
    ...
    - Рендеринг через шаблонизатор Pug
    - UI для управления пользователями с формами и кнопками действий
...
├── 📄 docker-compose.yml        # Docker Compose для многоконтейнерного приложения
